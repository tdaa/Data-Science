...
#- cor[c(1,11,15,...)] mostra as correlações, ou então com os plots / boxplot(y~varquantitativa), 
...
#- variáveis nao significativas podemos remover -> simplificacao do problema sem grande efeito no resultado final.
